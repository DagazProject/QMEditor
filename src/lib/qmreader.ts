...
export function createParam(name: string): QMParam {
  ...
  const critType: ParamCritType = ParamCritType.Максимум;
...
export function createLocation(id: LocationId): Location {
...
export function createJump(id: JumpId, fromLocationId: LocationId, toLocationId: LocationId, text: string, description: string): Jump {
