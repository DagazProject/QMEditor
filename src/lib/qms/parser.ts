...
import { addJump, addLocation, addParam, createJump, createLocation, createParam, createQm, Jump, JumpId, Location, LocationId, QM, QMParam } from "../qmreader";
...
export function loadQms(data: Buffer, encoding = 'utf-8') {
